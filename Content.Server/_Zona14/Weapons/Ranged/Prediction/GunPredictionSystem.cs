...
// Ported from RMC-14 Content.Server/_RMC14/Weapons/Ranged/Prediction/GunPredictionSystem.cs@2f5dc02e44.
using Content.Server._Zona14.Movement;
...
namespace Content.Server._Zona14.Weapons.Ranged.Prediction;
...
public sealed class GunPredictionSystem : SharedGunPredictionSystem
{
    ...
    public override void Initialize()
    {
        ...
        Subs.CVar(_config, Zona14CVars.GunPredictionPreventCollision, v => _preventCollision = v, true);
        Subs.CVar(_config, Zona14CVars.GunPredictionLogHits, v => _logHits = v, true);
        Subs.CVar(_config, Zona14CVars.GunPredictionCoordinateDeviation, v => _coordinateDeviation = v, true);
        Subs.CVar(_config, Zona14CVars.GunPredictionLowestCoordinateDeviation, v => _lowestCoordinateDeviation = v, true);
        Subs.CVar(_config, Zona14CVars.GunPredictionAabbEnlargement, v => _aabbEnlargement = v, true);
    }
